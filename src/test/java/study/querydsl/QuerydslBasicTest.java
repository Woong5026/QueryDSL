...
public class QuerydslBasicTest {
    ...
    public void join() throws Exception{
        List<Member> result = queryFactory
                .selectFrom(member)
                .join(member.team, team) // 여기서의 team은 Qteam을 칭함
                .where(team.name.eq("teamA"))
                .fetch();

        assertThat(result)
                .extracting("username")
                .containsExactly("member1", "member2"); // teamA에 소속된 회원이 1,2
    }
    /**
     * 세타 조인
    ...
    @Test
    public void NoneFetch() throws Exception{
        em.flush();
        em.clear();
